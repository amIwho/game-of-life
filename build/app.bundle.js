...
var Grid = function () {
  ...
  _createClass(Grid, [{
    ...
    value: function forEach(fn, context) {
      for (var y = 0; y < this.height; y += 1) {
        for (var x = 0; x < this.width; x += 1) {
          var value = this.grid[x + y * this.width];
          if (value != null) {
    ...
    value: function free(x, y) {
      ...
      return !this.directions.some(function (vector) {
        return _this.get(new _vector2.default(x, y).add(vector)) === 'X';
      });
    }
  }]);
...
exports.default = { get: get, post: postRequest };
